    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            ...
            <div class="main"><br/><br/>
                <h1 style="color: white">Patient Details</h1><br/>
                <table class="table table-striped table-bordered" style="color:white">
                    ...
                    <tr>
                        ...
                        <td>${ patient.name.firstName } &nbsp; &nbsp; ${ patient.name.middleName } &nbsp;
                            &nbsp; ${ patient.name.lastName } </td>    <!-- getters r used to access values -->
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><span
                                class="font-weight-bold"> Residential Address :</span><br> ${ patient.address.residentialAddress }
                            <br><br><span
                                    class="font-weight-bold"> Permanent Address :</span><br> ${ patient.address.permanentAddress }
                        </td>    <!-- getters r used to access values -->
                    </tr>
                    <tr>
