    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            ...
            <div class="main"><br/><br/>
                <h1 style="color: white">Add New Patient</h1><br/>
                    ...
                    <form action="addPatient.html" method="post" name="demo"><br/>
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1" name="chronicDiseases"
                                       value="none"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1" name="medicineAllergy"
                                       value="none"
                                       autocomplete="off" maxlength="50">
                            </div>
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control" id="exampleSelect1" name="doctorId">
                                            ...
                                            <% List<String[]> d = (List<String[]>) request.getAttribute("doctorsList");
                                                for (String[] str : d) { %>
                                            <option value="<%= str[0] %>"><%= str[1] + " " + str[2] + " " + str[3] %>
                                            </option>
                                            <%} %>
                                        </select>
                                    </div>
                            ...
                            <div style="text-align: center;">
                                <button type="submit" style="background-color: orange" class="btn btn-primary">Submit</button>
                            </div>
                        </div>
                    </form>
                    <br/></div>
