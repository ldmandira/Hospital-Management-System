	...
	<div class="row">
	   ...
	   <div class="col-sm-12">
	      <!-- display window -->
			...
			<h1 style="color: white">Search Existing Employee</h1></br>
			 		<%	
					try{
			...
			<div class="card bg-light border-primary mb-3"  style="background-color: #022140!important;" >
			...
			<div class="card bg-light border-danger mb-3" style="background-color: #022140!important;" >
			...
			<div class="card bg-light border-info mb-3" style="background-color: #022140!important;" >
			...
			<div class="card bg-light border-warning mb-3" style="background-color: #022140!important;" >
