...
<head>
    ...
    <style>
        ...
        input[type=text], input[type=date], select, input[type=email], textarea {
            background: #474747;
            color: white;
            border: none;
        }
                    ...
                    <form name="addEmp" action="addEmployee.html" method="post">
                        <div class="form-group"><br/>
                            ...
                            <div class="form-group">
                                <label>Gender</label>
                                <select class="form-control text-input" id="exampleSelect1" name="gender">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1" name="mobileNo"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1" name="adharNo"
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control text-input" id="exampleTextarea" rows="2"
                            ...
                            <div class="form-group">
                                <label>Role</label>
                                <select class="form-control text-input" id="exampleSelect1" name="role">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1" name="specialization"
