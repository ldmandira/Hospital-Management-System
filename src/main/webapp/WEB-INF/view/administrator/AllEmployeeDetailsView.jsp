	...
	<div class="row">
	   ...
	   <div class="col-sm-12">
	      <!-- display window -->
			...
			<h1 style="color: white">All Employees</h1><br/>
				<table class="table table-striped table-bordered" style="background-color: #474747; color: white">
			        ...
			        <td><%= emp.getName().getFirstName() %>&nbsp;<%= emp.getName().getMiddleName() %>&nbsp;<%= emp.getName().getLastName() %></td>	
			      	...
			      	<td> 
			      		<form action="viewEmployee.html" method="post">
			      			...
			      			<input type="submit" style="background-color: orange" class="btn btn-info" value="View">
			      			</div>
			      		</form>
			      	</td>
			      </tr>
