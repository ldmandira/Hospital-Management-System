    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            ...
            <div class="main"><br/><br/>
                ...
                <h3 style="color: white"><%=pname %>'s Observations and Prescription</h3><br/>

                <form action="addDopdPatientCase.html" method="post">
                    <div class="card bg-light border-primary mb-3" style="    background-color: #022140!important; color: white">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="exampleTextarea" rows="5" name="symptoms"
                                          placeholder="eg. #fever #headache #body pain"
                                          required="required" autocomplete="off" maxlength="200"></textarea>
                            </div>
                            <div class="form-group">
                                <label>Diagnosis</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" name="diagnosis"
                                       placeholder="eg. Typhoid"
                    ...
                    <div class="card bg-light border-primary mb-3 card-back" style="    background-color: #022140!important; color: white">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="exampleTextarea" rows="5" name="medicinesDose"
                                          placeholder="eg. #crocin-500@2 #TusQ-X@3 "
                                          required="required" autocomplete="off" maxlength="200"></textarea>
                            </div>
                            <div class="form-group">
                                <label>Do's</label>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:red;">*Note- Plz use # to seperate Do's.</span>
                                <input type="text" class="form-control" id="exampleInputEmail1" name="dos"
                                       placeholder="eg. #do1 #do2"
                                       required="required" autocomplete="off" maxlength="100">
                            </div>
                            <div class="form-group">
                                <label>Dont's</label>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:red;">*Note- Plz use # to seperate Don'ts.</span>
                                <input type="text" class="form-control" id="exampleInputEmail1" name="donts"
                                       placeholder="eg. #dont1 #dont2"
                                       required="required" autocomplete="off" maxlength="100">
                            </div>
                            <div class="form-group">
                                <label>Investigations</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" name="investigations"
                                       value="none" placeholder="eg. Blood test"
                                       required="required" autocomplete="off" maxlength="100">
                            </div>

                            <div class="form-group">
                                <label>Follow up date</label>
                                <input type="date" class="form-control" id="exampleInputEmail1" name="followupDate"
                                       placeholder="Choose followup Date"
                                       min="2020-03-14">
                            </div>
                            <div class="form-group">
                                <label>Fees</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" name="fees"
                                       placeholder="eg. 500"
