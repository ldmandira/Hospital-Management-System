	...
	<div class="row">
	    ...
	    <div class="col-sm-12" >
	      <!-- display window -->
			...
			<div class="card bg-light border-primary mb-3 card-back" style="	background-color: #022140!important;" >
			...
			<div class="card bg-light border-danger card-back mb-3"  style="	background-color: #022140!important;" >
			...
			<div class="card bg-light border-info mb-3  card-back " style="	background-color: #022140!important;"  >
			...
			<div class="card bg-light border-warning mb-3 card-back "  style="	background-color: #022140!important;" >
